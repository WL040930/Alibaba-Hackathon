...
class EnterNewData extends StatefulWidget {
  const EnterNewData({super.key});

  @override
  State<EnterNewData> createState() => _EnterNewDataState();
}

class _EnterNewDataState extends State<EnterNewData> {
  ...
  void initState() {
    ...
    _selectedCategory = CategoryEnum.values.first.name;
  }
